...
function Unit6Lesson2(finishedCallback) {
   ...
   var goalImages = {
      'static/images/goals/start7.PNG' : 'static/images/goals/goal7.PNG',
   };
   var that = BasicIdeLesson(world, starterCode, unitTests, goalImages, finishedCallback);
   return that; 
}
...
function Unit3Lesson6(finishedCallback) {
   ...
   var goalImages = {
      'static/images/goals/start4.PNG' : 'static/images/goals/goal4.PNG',
   };
   var that = BasicIdeLesson(world, starterCode, unitTests, goalImages, finishedCallback);
   return that;   
}
...
function Unit3Lesson5(finishedCallback) {
   ...
   var goalImages = {
      'static/images/goals/start3.PNG' : 'static/images/goals/goal3.PNG',
   };
   var that = BasicIdeLesson(world, starterCode, unitTests, goalImages, finishedCallback);
   return that;   
}
...
function Unit3Lesson3(finishedCallback) {
   var solution = 'static/karelCode/unit2Lesson3Soln.js';
   var world = '4x4';
   ...
   var goalImages = {
      'static/images/goals/start1.PNG' : 'static/images/goals/goal1.PNG',
   };
   var that = BasicIdeLesson(world, starterCode, unitTests, goalImages, finishedCallback);
   return that; 
}
...
function Unit3Lesson2(finishedCallback) {
   var solution = 'static/karelCode/unit2Lesson2Soln.js';
   var world = '4x4';
...
function Unit3Lesson1(finishedCallback) {
   var solution = 'static/karelCode/unit2Lesson1Soln.js';
   var world = '4x4';
...
function Unit2Lesson8(finishedCallback) {
   ...
   return ButtonLesson(buttons, 'ledge', 'static/karelCode/unit1Lesson5Soln.js', finishedCallback);
}
...
function Unit2Lesson7(finishedCallback) {
   ...
   return ButtonLesson(buttons, '1x3Beeper', 'static/karelCode/moveAndPickSln.js', finishedCallback);
}
...
function Unit2Lesson6(finishedCallback) {
   ...
   return ButtonLesson(buttons, '1x3', 'static/karelCode/unit1Lesson4Soln.js', finishedCallback);
}
...
function Unit2Lesson5(finishedCallback) {
   ...
   return ButtonLesson(buttons, '1x1', 'static/karelCode/simplePutSln.js', finishedCallback);
}
...
function Unit2Lesson4(finishedCallback) {
   ...
   return ButtonLesson(buttons, 'turnLeft', 'static/karelCode/unit1Lesson3Soln.js', finishedCallback);
}
...
function Unit2Lesson3(finishedCallback) {
   ...
   return ButtonLesson(buttons, '1x1', 'static/karelCode/simpleTurnLeftSln.js', finishedCallback);
}
...
function Unit2Lesson2(finishedCallback) {
   ...
   return ButtonLesson(buttons, 'move', 'static/karelCode/unit1Lesson2Soln.js', finishedCallback);
}
...
function Unit2Lesson1(finishedCallback) {
   ...
   return ButtonLesson(buttons, '2x2', 'static/karelCode/simpleMoveSln.js', finishedCallback);
}
...
function Unit1Lesson2(finishedCallback) {
   var buttonSrcs = [
      '/static/images/karelIcon.png',
      '/static/images/beeperIcon.png',
